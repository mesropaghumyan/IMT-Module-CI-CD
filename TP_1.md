...
![Apparition du Runner avec une pastille verte](images/TP_1/PARTIE_3/3-screen-1.png)
...
![Pipeline qui échoue à cause de l'erreur HTML](images/TP_1/PARTIE_4/4-screen-1.png)

![Cause de l'erreur HTML](images/TP_1/PARTIE_4/4-screen-2.png)
...
![Ajout de l'image gitlab dans le répo](images/TP_1/PARTIE_5/5-screen-1.png)
...
![Etat du job de la compression d'image](images/TP_1/PARTIE_5/5-screen-4.png)
...
![Artifact téléchargé](images/TP_1/PARTIE_5/5-screen-8.png)
...
![Pipelines de la mise en place de stages](images/TP_1/PARTIE_6/6-screen-2.png)
...
![Mise en place du job build_artifacts](images/TP_1/PARTIE_7/7-screen-2.png)
...
![Ajout de la clé privée](images/TP_1/PARTIE_7/7-screen-3.png)

![Ajout de l'empreinte](images/TP_1/PARTIE_7/7-screen-8.png)
...
![Déploiement final de la page de test](images/TP_1/PARTIE_7/7-screen-11.png)

Pipeline qui passe avec succès :

![Pipeline de déploiement](images/TP_1/PARTIE_7/7-screen-5.png)

Affichage de la page de test :

![Affichage de la page de test](images/TP_1/PARTIE_7/7-screen-7.png)
...
![Affichage de la page de dev](images/TP_1/PARTIE_8/8-screen-1.png)

**Branche main** : Déploiement vers `/var/www/html/main` avec déclenchement manuel (`when: manual`).

![Affichage de la page de prod](images/TP_1/PARTIE_8/8-screen-2.png)
...
![Dépôt externe Gitlab CI YML](images/TP_1/PARTIE_9/9-screen-1.png)

Dans le projet principal, nous avons pointé vers ce fichier distant : `.gitlab-ci.yml@cicd/gitlab-ci-yml`.

![Pointage vers le fichier distant](images/TP_1/PARTIE_9/9-screen-2.png)
...
![Création du projet RenovateBot](images/TP_1/PARTIE_10/10-screen-1.png)

- Configuration des settings CI/CD.

![Configuration des settings CI/CD du projet RenovateBot](images/TP_1/PARTIE_10/10-screen-2.png)

- Configuration du token d'accès.

![Configuration du token d'accès de RenovateBot](images/TP_1/PARTIE_10/10-screen-3.png)

- Configuration d'un Pipeline Schedule quotidien.

![Configuration du pipeline schedule quotidien](images/TP_1/PARTIE_10/10-screen-8.png)
...
![MR pour passé de debian 12 à 13 propulsé par RenovateBot](images/TP_1/PARTIE_10/10-screen-10.png)
...
![Utilisation de release-cli](images/TP_1/PARTIE_11/11-screen-3.png)
...
![Génération du release](images/TP_1/PARTIE_11/11-screen-6.png)

Chaine complète du pipeline :

![Chaine complète du pipeline](images/TP_1/PARTIE_11/11-screen-8.png)
